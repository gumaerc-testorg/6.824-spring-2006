...
You could look for inspiration about hot topics in the on-line proceedings of recent {{% resource_link "c5f2e4c5-de2a-4f50-a15f-fb0e7dede7fb" "SOSP" %}}, {{% resource_link "11d279fb-9b9d-4d2f-a516-ea8fbf1221b4" "OSDI" %}}, {{% resource_link "16c3ba99-ea26-49cb-a94c-65ecd0a44eda" "Usenix" %}}, and {{% resource_link "5296a74a-fb89-4f85-93f6-df2b44cda959" "NSDI" %}} conferences. You might also want to look at 6.824 projects from previous years. ({{% resource_link 2d17c206-9a82-c00f-08fa-dde727802bec "PDF" %}})
...
*   Build a service on top of the {{% resource_link "2ad9146d-2d1b-418d-a12e-7b3403440680" "PlanetLab" %}} research test-bed.
...
*   Build a service that maintains consistent replicated data. You could build a general-purpose service (like DDS) or an application that replicates in a way tailored to that application's needs (like the Porcupine mailbox service ({{% resource_link "a5403953-e286-4795-bbc4-c3615ce19ebd" "PS" %}}).)
